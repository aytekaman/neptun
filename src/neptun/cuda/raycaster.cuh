...
__device__
inline TetMesh80::Plucker make_plucker_from_ray(glm::vec3 ray_orig, glm::vec3 ray_dir)
{
	TetMesh80::Plucker pl_ray;
	const glm::vec3 v = glm::cross(ray_orig, ray_orig + ray_dir);
	pl_ray.m_Pi[0] = ray_dir[0];
	pl_ray.m_Pi[1] = ray_dir[1];
	pl_ray.m_Pi[2] = ray_dir[2];
	pl_ray.m_Pi[3] = v[0];
	pl_ray.m_Pi[4] = v[1];
	pl_ray.m_Pi[5] = v[2];
