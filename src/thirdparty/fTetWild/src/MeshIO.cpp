                    ...
                    const std::function<bool(int)>& skip_vertex)
{
    ...
    if (output_format == "mesh") {
        ...
        output_mesh << "Vertices #" << cnt_v << std::endl;
        ...
        for (size_t i = 0; i < mesh.tet_vertices.size(); i++) {
            ...
            output_mesh << mesh.tet_vertices[i][0] << " " << mesh.tet_vertices[i][1] << " "
              << mesh.tet_vertices[i][2] << std::endl;
        }
        ...
        output_mesh << "Tetrahedras #" << cnt_t << std::endl;
        ...
        for (const int i : t_ids) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                output_mesh << old_2_new[mesh.tets[i][j]] << " ";
